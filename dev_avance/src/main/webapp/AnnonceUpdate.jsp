...
<head>
    <meta charset="UTF-8">
    <title>Edit Annonce - MasterAnnonce</title>
...
<body>
    <nav>
        ...
        <div><a href="AnnonceList">Cancel</a></div>
    </nav>
    ...
    <div class="container">
        <form action="AnnonceUpdate" method="post">
            ...
            <input type="text" value="${annonce.category != null ? annonce.category.label : 'None'}" disabled style="background-color: #e5e7eb; color: #6b7280;">
